...
Prompt pais
create or replace synonym pais_f1 for PAIS_F1_RDVG_S1;
...
create or replace synonym sucursal_f2 for SUCURSAL_F2_RDVG_S1;
...
create or replace synonym auto_f2 for AUTO_F2_RDVG_S1;
create or replace synonym auto_f3 for AUTO_F3_RDVG_S2@rdvgbdd_s2;

Prompt auto_particular 
create or replace synonym auto_particular_f1 for AUTO_PARTICULAR_F1_RDVG_S1;
create or replace synonym auto_particular_f2 for AUTO_PARTICULAR_F2_RDVG_S2@rdvgbdd_s2;

Prompt auto_carga 
create or replace synonym auto_carga_f1 for AUTO_CARGA_F1_RDVG_S1;
...
Prompt marca 
create or replace synonym marca_r1 for MARCA_R_RDVG_S1;
create or replace synonym marca_r2 for MARCA_R_RDVG_S2@rdvgbdd_s2;
...
Prompt modelo 
create or replace synonym modelo_r1 for MODELO_R_RDVG_S1;
create or replace synonym modelo_r2 for MODELO_R_RDVG_S2@rdvgbdd_s2;
