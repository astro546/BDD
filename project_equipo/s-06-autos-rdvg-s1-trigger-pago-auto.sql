Prompt creando trigger para pago_auto en rdvgbdd_s1
...
begin
  case 
    when inserting then 
      ...
      if v_count > 0 then
        insert into ti_pago_auto_fx values (
          :new.cliente_id,
          :new.auto_id,
          :new.fecha_pago,
          :new.importe,
          :new.recibo_pago);
          insert into pago_auto_f1 (select * from ti_pago_auto_fx);
          delete from ti_pago_auto_fx where cliente_id = :new.cliente_id 
        ...
        if v_count > 0 then
          insert into ti_pago_auto_fx values (
            ...
            insert into pago_auto_f2 (select * from ti_pago_auto_fx);
            delete from ti_pago_auto_fx where cliente_id = :new.cliente_id 
            and auto_id = :new.auto_id;            
          ...
          if v_count > 0 then
            ...
            insert into pago_auto_f3 (select * from ti_pago_auto_fx);
            delete from ti_pago_auto_fx where cliente_id = :new.cliente_id 
            and auto_id = :new.auto_id;  
