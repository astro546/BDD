--@author: Ricardo Vega
--@Date: 30-may-2024
--@Description: Synonym for aeggbdd_s2
...
Prompt auto 
create or replace synonym auto_f1 for AUTO_F1_AEGG_S2;
...
create or replace synonym HISTORICO_STATUS_AUTO_F1 for HISTORICO_STATUS_AUTO_F1_AEGG_S2;
create or replace synonym HISTORICO_STATUS_AUTO_F2 for HISTORICO_STATUS_AUTO_F2_AEGG_S1@aeggbdd_s1;

Prompt marca 
create or replace synonym marca_r1 for MARCA_R_AEGG_S2;
...
create or replace synonym marca_r4 for MARCA_R_AEGG_S1@aeggbdd_s1;

Promp modelo 
create or replace synonym modelo_r1 for MODELO_R_AEGG_S2;
...
create or replace synonym modelo_r4 for MODELO_R_AEGG_S1@aeggbdd_s1;
...
create or replace synonym cliente_f3 for CLIENTE_F3_AEGG_S2;
...
create or replace synonym pago_auto_f3 for PAGO_AUTO_F3_AEGG_S2;